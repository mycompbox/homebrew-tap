...
class CompboxAT117 < Formula
  ...
  url "https://github.com/mycompbox/homebrew-tap/releases/download/cli-v1.17.1/compbox-macos.tar.gz"
  version "1.17.1"
  sha256 "726e3760a0d91a351bdc79d08496b61ae446f2109f9b7f003d2e9b4df745a04b"
  ...
  def caveats
    <<~EOS
      ...
      Step 3 is a ONE-TIME registration: installing the formula does NOT start
      the daemon. Until it runs, the web app's "Run on Your Machine" reports
      this machine as offline. Once registered, launchd starts the daemon at
      every login (including after reboots) and restarts it if it crashes.
      `compbox configure` (step 2) also offers to run step 3 for you.
